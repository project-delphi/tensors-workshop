...
|---|---|---|
| **[Manual](../tensors_workshop_plan_with_quizzes.md)** | El texto de la sesión: la teoría, todos los ejercicios, las soluciones comentadas y los cinco apéndices para casa. **Solo en inglés.** | Léelo antes, síguelo durante, consérvalo después. |
...
| **[Cuadernos](../notebooks.qmd)** | Catorce cuadernos de Colab: uno por sección, más un estudio a fondo para casa. Donde realmente escribes código. | Durante cada sección, y para el ejercicio de casa. |
...
y todas las tablas de secciones de esta página se generan a partir de ahí, así que no pueden
contradecirse.
...
**No aparecen** en la tabla: las tres pausas de 5 minutos. Las trece secciones
suman 180 minutos; los tres cuestionarios añaden 15 y las pausas otros 15, que
