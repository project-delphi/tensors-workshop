...
::: {.ds}
![](../../images/ds-digits.jpg){fig-alt="Eight handwritten digits from scikit-learn's load_digits, each 8 by 8 pixels, shown unsmoothed so the individual pixels stay visible."}
