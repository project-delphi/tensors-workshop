...
- `np.linalg` — the rest of Chapter 2: `eig`, `lstsq`, `pinv`, `qr`
...
**Three take-homes** in [notebook 11]({{< var repo.colab_base >}}/11-wrap-up-and-take-homes.ipynb):
the PCA scaling trap, attention as two contractions, and CP compared to Tucker.
