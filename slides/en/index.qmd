...
[California housing](https://github.com/ageron/handson-ml2/blob/master/datasets/housing/housing.csv) · §07

[Photographs, histology](https://scikit-image.org/docs/stable/api/skimage.data.html) · §01 §04 §06 §09 §10
:::
:::
...
hologram rather than a stained slide.

Image credits, all CC0 and none required: taxis Ferdinand Stohr, DC-3 Bernard
Spragg, histopathology Mikael Haggstrom MD (Wikimedia Commons); storm Nicolas
Vigier (Commons); voice Bart Massey. Digits, cell and waveform are rendered
from the data itself by scripts/gen_thumbnails.py.
:::
