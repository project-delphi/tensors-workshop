...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s00.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s00.start >}} · Fin: {{< var sections.s00.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s01.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s01.start >}} · Fin: {{< var sections.s01.end >}}]{.pace-window}
:::
...
*Parte II · demostración · código*

::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s02.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s02.start >}} · Fin: {{< var sections.s02.end >}}]{.pace-window}
:::

## La misma forma, ejes distintos

`digits.images` es `(1797, 8, 8)` y una foto es `(512, 512, 3)` — ambas de orden
3, pero el eje 0 cuenta **imágenes** en una y **filas de píxeles** en la otra. En
el cuaderno, `digit_batch` y `video_patch` son *ambos* `(8, 8, 8)`: uno apila
ejemplos independientes, el otro apila instantes ordenados.

. . .

**Barajar el eje 0** es inofensivo en un lote — los ejemplos son independientes —
y **destruye** un vídeo, donde el orden *es* la información. La misma operación,
un significado completamente distinto. La notación del capítulo 2 no tiene ningún
concepto de «el orden entre elementos importa»; eso sí es nuevo hoy.

## Los clips de distinta duración necesitan una máscara

Los vídeos reales tienen longitudes distintas, pero un tensor de lote es
rectangular. El cuaderno toma tres clips reales de longitud 4, 7 y 5, los rellena
en un lote de orden 5 `(3, 7, 135, 240, 3)` y lleva una **máscara de validez**
booleana `(3, 7)` — así `valid.sum() == 16` y el relleno queda visible en vez de
promediarse en los datos.
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s03.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s03.start >}} · Fin: {{< var sections.s03.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s04.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s04.start >}} · Fin: {{< var sections.s04.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s05.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s05.start >}} · Fin: {{< var sections.s05.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s06.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s06.start >}} · Fin: {{< var sections.s06.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s07.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s07.start >}} · Fin: {{< var sections.s07.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s08.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s08.start >}} · Fin: {{< var sections.s08.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s09.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s09.start >}} · Fin: {{< var sections.s09.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s10.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s10.start >}} · Fin: {{< var sections.s10.end >}}]{.pace-window}
:::
...
::: {.pace-badge}
[[⏱️]{.pace-icon}**{{< var sections.s11.minutes >}} min** asignados]{.pace-duration}

[Inicio: {{< var sections.s11.start >}} · Fin: {{< var sections.s11.end >}}]{.pace-window}
:::
