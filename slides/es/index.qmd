...
Créditos de las imágenes, todas CC0 y ninguna obligatoria: taxis Ferdinand
Stohr, DC-3 Bernard Spragg, histopatología Mikael Haggstrom MD, viviendas en
serie Alfred Twu (Wikimedia Commons); tormenta Nicolas Vigier (Commons); voz
Bart Massey. Los dígitos, la célula, la histología y la onda se generan a
partir de los propios datos con scripts/gen_thumbnails.py.
:::

## Programa — {{< var workshop.minutes >}} minutos

| Parte | Segmento | Tiempo |
|---|---|---|
| — | Preparación y bienvenida | 5 |
| I | Qué es un tensor | 20 |
| II | Pensar en N dimensiones *(grupo)* | 20 |
| III | Indexación y broadcasting · Reshape y transposición | 30 |
| 🎯 | **Kahoot 1** + pausa | 10 |
| III | Diseño de un pipeline de vídeo *(grupo)* | 15 |
| IV | Contracción con einsum | 15 |
| — | Pausa | 5 |
| IV | Inversas y la pseudoinversa | 15 |
| 🎯 | **Kahoot 2** | 5 |
| IV | Recursión · Convolución | 25 |
| — | Pausa | 5 |
| IV | Descomposición de Tucker | 15 |
| 🎯 | **Kahoot 3** + cierre | 10 |
