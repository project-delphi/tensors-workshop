...
[Vivienda en California](https://github.com/ageron/handson-ml2/blob/master/datasets/housing/housing.csv) · §07

[Fotografías, histología](https://scikit-image.org/docs/stable/api/skimage.data.html) · §01 §04 §06 §09 §10
:::
:::
...
una imagen de fase de un holograma, no una preparación teñida.

Créditos de las imágenes, todas CC0 y ninguna obligatoria: taxis Ferdinand
Stohr, DC-3 Bernard Spragg, histopatología Mikael Haggstrom MD (Wikimedia
Commons); tormenta Nicolas Vigier (Commons); voz Bart Massey. Los dígitos, la
célula y la onda se generan a partir de los propios datos con
