...
::: {.incremental}
- Medidas reales de tumores, dígitos manuscritos reales, histología real
- Viajes reales en taxi, tráfico aéreo real
- **Nada está inventado con números aleatorios**
:::

. . .

Los datos reales tienen problemas que los aleatorios nunca muestran: valores
...
- `np.linalg` — el resto del capítulo 2: `eig`, `lstsq`, `pinv`, `qr`
...
**Tres ejercicios para casa** en el
[cuaderno 11]({{< var repo.colab_base >}}/11-wrap-up-and-take-homes.ipynb):
la trampa de escala de PCA, la atención como dos contracciones, y CP frente a
Tucker.
