...
(function () {
  ...
  const EN = {
    ...
    concept: 'CP writes a tensor as a sum of R rank-1 terms, each a weight and three vectors: R(I + J + K) numbers in all. Unlike Tucker it has no core and no orthogonality: the terms can overlap, and nothing forces them to be unique. <span class="cite">Kolda &amp; Bader §3.2–3.3</span>',
  ...
  const ES = {
    ...
    concept: 'CP escribe un tensor como una suma de R términos de rango 1, cada uno un peso y tres vectores: R(I + J + K) números en total. A diferencia de Tucker no tiene núcleo ni ortogonalidad: los términos pueden solaparse, y nada los obliga a ser únicos. <span class="cite">Kolda &amp; Bader §3.2–3.3</span>',
    claim: "T ≈ Σᵣ λᵣ aᵣ ⊗ bᵣ ⊗ cᵣ,  R(I + J + K) = 99",
