...
(function () {
  ...
  const ES = {
    ...
    b: "<p>Este es el modelo de Tucker entero en un escenario: el núcleo G en el medio, y una matriz factor contra cada uno de sus lados: C a la derecha, una fila de 24 teselas por patrón horario, A debajo para el origen y B encima para el destino, cada tesela del tamaño de su entrada. En los rangos (2, 2, 3) guardan 102 números en lugar de 480: un ahorro de 4,71×, con un error relativo del 6,7%. Son los números de HOSVD (una SVD por desplegado, no un ajuste iterativo) y en cada rango que compara el cuaderno 11, su ajuste iterativo de Tucker coincide con HOSVD hasta la cuarta cifra.</p><p>Cada conteo de viajes es una suma sobre el núcleo: cada entrada G[a, b, c] pondera un patrón de origen, uno de destino y uno horario. Haz clic en un vóxel del núcleo, o en una columna de un factor, para elegir la entrada que la multiplica. Una entrada, G[0, 0, 0] = 1.096,8, es por sí sola el 99,4% del ajuste: Manhattan, Manhattan y el día. Cambia la vista para ver el cubo que reconstruye, y lo que se deja.</p>",
